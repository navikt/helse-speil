const personlookupFactory = require('./personlookup');
...
beforeAll(() => {
    personlookup = personlookupFactory.build({
...
describe('sakSøk', () => {
    const baseReq = {
        headers: { [personlookupFactory.personIdHeaderName]: '123' },
        session: {}
    };
    ...
    describe('oppslag på fødselsnummer', () => {
        const reqWithFnr = {
            ...baseReq,
            headers: { ...baseReq.headers, [personlookupFactory.personIdHeaderName]: '11031888001' }
        };
