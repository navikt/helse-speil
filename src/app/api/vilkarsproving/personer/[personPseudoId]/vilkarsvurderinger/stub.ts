import { ApiVilkårsvurderingerForPersonResponse, ApiKravkode, ApiVilkårskode, ApiUtfall, ApiKildetype, ApiKravkilde } from "@/io/rest/generated/vilkarsproving.schemas";
...
export const stub = async () =>
    Response.json(vilkarsvurderingerStub);
