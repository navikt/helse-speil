...
export const getNotaterForVedtaksperiode = (vedtaksperiodeId: string, signal?: AbortSignal) => {
...
export const getGetNotaterForVedtaksperiodeQueryKey = (vedtaksperiodeId?: string) => {
    return [`/api/spesialist/vedtaksperioder/${vedtaksperiodeId}/notater`] as const;
};
...
>(
    ...
    options?: {
        query?: Partial<UseQueryOptions<Awaited<ReturnType<typeof getNotaterForVedtaksperiode>>, TError, TData>>;
    },
) => {
    const { query: queryOptions } = options ?? {};
    ...
    const queryFn: QueryFunction<Awaited<ReturnType<typeof getNotaterForVedtaksperiode>>> = ({ signal }) =>
        getNotaterForVedtaksperiode(vedtaksperiodeId, signal);

    return {
        queryKey,
        queryFn,
        enabled: !!vedtaksperiodeId,
        staleTime: Infinity,
        gcTime: 0,
        ...queryOptions,
    } as UseQueryOptions<Awaited<ReturnType<typeof getNotaterForVedtaksperiode>>, TError, TData> & {
        queryKey: DataTag<QueryKey, TData, TError>;
    };
};
