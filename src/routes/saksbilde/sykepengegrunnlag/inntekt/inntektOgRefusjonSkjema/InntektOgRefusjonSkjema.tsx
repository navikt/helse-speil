...
import { ArbeidsgiverFragment, Kildetype, Maybe, OmregnetArsinntekt, PersonFragment } from '@io/graphql';
...
import { useLokaleRefusjonsopplysninger, usePeriodForSkjæringstidspunktForArbeidsgiver } from '@state/arbeidsgiver';
