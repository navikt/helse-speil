 ...
 */
export const useTilkommenInntektPeriodStyling = (
    start: Dayjs,
    end: Dayjs,
    periods: Array<TilkommenInntekt>,
    ...
    useMemo(() => {
        ...
        const datePeriods: Array<StyledPeriod> = periods.map((period) => {
            return {
                ...period,
                fom: dayjs(period.periode.fom).startOf('day'),
                tom: dayjs(period.periode.tom).endOf('day'),
            };
        });
