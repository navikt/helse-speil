...
import { tilkommenInntektSchema } from '@/form-schemas/index';
...
const validerTilkommenInntektSkjema = (
    ...
    tilkommenInntektSchema('2020-01-01', [
...
describe('tilkommenIkktekt skjemavalidering', () => {
    ...
    it('organisasjonsnummer skal være 9 sifre', () => {
        ...
        expect(hentFeilmelding(validerTilkommenInntektSkjema(1234567891))).toBe('Organisasjonsnummer må være 9 siffer');
    });
