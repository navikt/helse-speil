...
export const umappetInntektsgrunnlag = (inntektskilde: SpesialistInntektkilde = SpesialistInntektkilde.Inntektsmelding): SpesialistInntektsgrunnlag => ({
    skjæringstidspunkt: '2020-01-01',
    sykepengegrunnlag: 372000.0,
    omregnetÅrsinntekt: 372000.0,
    sammenligningsgrunnlag: inntektskilde === SpesialistInntektkilde.Inntektsmelding
        ? 372000.0
        : undefined,
    avviksprosent: 0.0,
    maksUtbetalingPerDag: 1430.7692307692,
