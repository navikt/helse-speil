...
test('buildDagsatserDictionary bygger et objekt som inneholder alle datoer som nøkler', () => {
    ...
    expect(dagsatser['2019-09-21']).toBeUndefined();
    expect(dagsatser['2019-09-22']).toBeUndefined();
    ...
    expect(dagsatser['2019-09-28']).toBeUndefined();
    expect(dagsatser['2019-09-29']).toBeUndefined();
    ...
    expect(dagsatser['2019-10-05']).toBeUndefined();
