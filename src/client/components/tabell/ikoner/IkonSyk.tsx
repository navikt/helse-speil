...
export const IkonSyk = ({ width = 16, height = 16, fill = '#b7b0a9' }) => (
    <svg height={height} width={width} viewBox="0 0 24.14 24.15" xmlns="http://www.w3.org/2000/svg">
        <path
            fill={fill}
        ...
        <path
            fill={fill}
            transform="translate(.15 .16)"
            d="M22.24,13.75l-3.17-3.17-8.48,8.48,3.17,3.17A6,6,0,0,0,18,24h0A6,6,0,0,0,22.24,13.75ZM14.83,17a0.5,0.5,0,1,1-.14.34A0.5,0.5,0,0,1,14.83,17Zm1.06,3.18a0.5,0.5,0,0,1-.71,0h0a0.5,0.5,0,1,1,.71-0.05v0.05Zm1.06-5.3a0.5,0.5,0,1,1,0,.71,0.5,0.5,0,0,1,0-.71h0Zm0.35,2.42a0.5,0.5,0,1,1,0,.71,0.5,0.5,0,0,1,0-.71h0Zm1.06,3.18a0.5,0.5,0,1,1,0-.71h0a0.49,0.49,0,0,1,0,.69h0Zm1.06-5.3a0.51,0.51,0,1,1-.1.35,0.5,0.5,0,0,1,.1-0.35h0Zm1.06,3.18A0.49,0.49,0,1,1,20.63,18a0.5,0.5,0,0,1-.15.35h0Z"
        />
        <rect fill={fill} transform="translate(-4.93 12.11) rotate(-45)" x="5.89" y="9.11" width="12" height="6" />
    </svg>
);
