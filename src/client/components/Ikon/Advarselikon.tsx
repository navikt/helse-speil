    ...
    <Ikon height={height} width={width} viewBoxSize={viewBoxSize}>
        <g fill="none" fillRule="evenodd">
            <path
                ...
                fillRule="nonzero"
            />
            <path d="M12.027 19H12a1.499 1.499 0 01-.027-3H12a1.501 1.501 0 01.027 3z" fill="#3E3832" />
            <path d="M12 5a1 1 0 011 1v7a1 1 0 01-2 0V6a1 1 0 011-1z" fill="#3E3832" fillRule="nonzero" />
        </g>
    </Ikon>
);
