...
const GrøntSjekkikon = () => (
    <Ikon width={25} height={25} viewBoxSize={25}>
        <g id="Helse-Copy-2" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
            <g id="check-circle-2-copy-10" transform="translate(1.000000, 1.000000)" fillRule="nonzero">
                <path
