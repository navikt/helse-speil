...
const AutomatiskUtbetaltePerioderIkon = () => {
    ...
    return <img src={imageData} aria-label="Perioder som er automatisk utbetalt" alt="" />;
};
...
const UtbetaltePerioderIkon = () => {
    ...
    return <img src={imageData} aria-label="Perioder som er manuelt utbetalt" alt="" />;
};
...
const AnnullertePerioderIkon = () => {
    ...
    return <img src={imageData} aria-label="Perioder med fagsystem-id som er annullert" alt="" />;
};
