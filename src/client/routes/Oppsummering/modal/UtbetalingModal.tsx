...
const UtbetalingModal = ({ isSending, onApprove, onClose }: Props) => (
    <StyledModal isOpen={true} contentLabel="Godkjenn utbetaling" closeButton={true} onRequestClose={onClose}>
...
export default UtbetalingModal;
