...
describe('Toppvarsler', () => {
    test('viser infovarsel når saken har gått til utbetaling', () => {
        ...
        render(<Toppvarsler vedtaksperiode={mappetVedtaksperiode()} aktivPeriode={periodeTilUtbetaling} />);
    ...
    test('viser infovarsel når saken har blitt utbetalt', () => {
        ...
        render(<Toppvarsler vedtaksperiode={mappetVedtaksperiode()} aktivPeriode={utbetaltPeriode} />);
        expect(screen.getByText('Utbetalingen er sendt til oppdragsystemet.')).toBeVisible();
    });
    test('viser infovarsel når saken er godkjent uten utbetaling', () => {
        ...
        render(<Toppvarsler vedtaksperiode={mappetVedtaksperiode()} aktivPeriode={periodeUtenUtbetaling} />);
    ...
    test('viser infovarsel når saken kun inneholder ferie', () => {
        ...
        render(<Toppvarsler vedtaksperiode={mappetVedtaksperiode()} aktivPeriode={ferieperiode} />);
        expect(screen.getByText('Perioden er godkjent, ingen utbetaling.')).toBeVisible();
    });
    test('viser infovarsel når saken kun inneholder permisjon', () => {
        ...
        render(<Toppvarsler vedtaksperiode={mappetVedtaksperiode()} aktivPeriode={permisjonperiode} />);
        expect(screen.getByText('Perioden er godkjent, ingen utbetaling.')).toBeVisible();
    });
    test('viser feilvarsel om utbetaling har feilet', () => {
        const feiletperiode = enTidslinjeperiode(Tidslinjetilstand.Feilet);
        render(<Toppvarsler vedtaksperiode={mappetVedtaksperiode()} aktivPeriode={feiletperiode} />);
    ...
    test('viser infovarsel om saken er annullert', () => {
        ...
        render(<Toppvarsler vedtaksperiode={mappetVedtaksperiode()} aktivPeriode={periode} />);
    ...
    test('viser infovarsel om vedtaksperioden er kandidat for automatisering', () => {
        ...
        render(<Toppvarsler vedtaksperiode={periode} aktivPeriode={enTidslinjeperiode(Tidslinjetilstand.Oppgaver)} />);
    ...
    test('viser varslerState fra aktivitetsloggen', () => {
        ...
        render(<Toppvarsler aktivPeriode={enTidslinjeperiode(Tidslinjetilstand.Oppgaver)} vedtaksperiode={periode} />);
