...
export const Advarselikon = ({ height = 24, width = 24, viewBox, className, alt }: IkonProps) => (
    <Ikon height={height} width={width} viewBox={viewBox} className={className} alt={alt}>
        <g fill="none" fillRule="evenodd">
            <path
                ...
                fill="var(--ax-warning-500)"
                fillRule="nonzero"
            />
            <path d="M12.027 19H12a1.499 1.499 0 01-.027-3H12a1.501 1.501 0 01.027 3z" fill="var(--ax-text-neutral)" />
            <path
