...
import { getUser } from '@/lib/auth';
import { createResource, fetchData } from '@/lib/{{ressurs}}';
...
🔴 **Rød sone**: Auth checks and input validation are security-critical — understand _why_ each check exists before adapting this pattern.
