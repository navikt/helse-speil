    ...
    return (
        <VStack gap="space-16">
            <LocalAlert status="error">
                ...
                <LocalAlert.Content>
                    Det oppsto en feil under innlastingen av data. Prøv igjen senere. Hvis problemet vedvarer, kontakt
                    support.
                </LocalAlert.Content>
            </LocalAlert>
...
const mutation = useMutation({
    mutationFn: (data: CreateRequest) => fetch('/api/resources', { method: 'POST', body: JSON.stringify(data) }),
