...
<div className="flex flex-col gap-4 lg:gap-8 md:flex-row md:gap-6">
    <div className="w-full lg:w-1/3 md:w-1/2">Content</div>
</div>;
```
...
<button className="bg-blue-500 text-white hover:bg-blue-600 focus:ring-blue-500 focus:ring-2 focus:ring-offset-2 focus:outline-none">
    Button
</button>;
