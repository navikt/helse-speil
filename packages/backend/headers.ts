...
const cspString = `default-src 'self' data: ws:; style-src 'self' ${styleSource} data: 'unsafe-inline'; connect-src 'self' ${arbeidOgInntektSource} ${navNo} ${sanity} blob: ${amplitudeSource}; font-src ${fontSource} 'self' data:`;
