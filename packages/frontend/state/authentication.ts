...
import { extractStartsWithSpeilValues, Keys } from '@utils/cookie';
...
export const useAuthentication = () => {
    ...
    const [name, ident, email, oid] = extractStartsWithSpeilValues([Keys.NAME, Keys.IDENT, Keys.EMAIL, Keys.OID]);
