...
export const IconEgenmelding = ({ width = 16, height = 16, fill = 'var(--navds-semantic-color-text)' }) => (
    <svg
        width={width}
        height={height}
    ...
    >
        <path
            ...
            fill={fill}
        />
        <path fillRule="evenodd" clipRule="evenodd" d="M11.3333 4.66667H4.66667V3.33333H11.3333V4.66667Z" fill={fill} />
