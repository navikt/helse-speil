...
const finnType = (varselvurdering: Maybe<VarselvurderingDto> | undefined): VarselstatusType => {
...
export type VarselstatusType = 'aktiv' | 'vurdert' | 'ferdig-behandlet';
            ...
            {varsler
                ...
                .map((varsel, index) => {
                    ...
                    if (varsel.forklaring !== null && varsel.handling !== null) {
                        return <EkspanderbartVarsel key={index} varsel={varsel} type={type} />;
                    } else {
